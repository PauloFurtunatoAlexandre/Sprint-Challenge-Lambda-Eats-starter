...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   //useRouteMatch hook is used to access the match data.

2. How would you explain form validation to someone who has never programmed before?
   Form validation is a way a form has to make sure all the information there is in the correct shape and/or type.

3. In 1-2 sentences, define end to end testing.
   End to end test can be compared with the expected user experience, to make sure all user’s actions will reflect the correct things an user can do.
